	...
	tests := []struct {
		...
		{name: "nil-map-nonstr-key",
			args: args{[]tengo.Object{
				&tengo.Map{}, &tengo.Number{}}}, wantErr: true,
			wantedErr: tengo.ErrInvalidArgumentType{
...
func Test_builtinSplice(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "negative index",
			args:      []tengo.Object{&tengo.Array{}, &tengo.Number{Value: -1}},
			wantErr:   true,
			wantedErr: tengo.ErrIndexOutOfBounds},
		{name: "non int count",
			args: []tengo.Object{
				&tengo.Array{}, &tengo.Number{Value: 0},
				&tengo.String{Value: ""}},
			wantErr: true,
			wantedErr: tengo.ErrInvalidArgumentType{
		...
		{name: "insert with delete",
			args: []tengo.Object{
				...
				&tengo.String{Value: "d"}},
			deleted: &tengo.Array{
				Value: []tengo.Object{&tengo.Number{Value: 1}}},
			Array: &tengo.Array{Value: []tengo.Object{
				&tengo.Number{Value: 0},
				&tengo.String{Value: "c"},
				&tengo.String{Value: "d"},
		...
		{name: "pop without count",
			args: []tengo.Object{
				&tengo.Array{Value: []tengo.Object{
					...
					&tengo.Number{Value: 2}}},
				&tengo.Number{Value: 2}},
			deleted: &tengo.Array{Value: []tengo.Object{&tengo.Number{Value: 2}}},
			Array: &tengo.Array{Value: []tengo.Object{
				&tengo.Number{Value: 0}, &tengo.Number{Value: 1}}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_builtinRange(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "invalid stop",
			args:    []tengo.Object{&tengo.Number{}, &tengo.String{}},
			wantErr: true,
			wantedErr: tengo.ErrInvalidArgumentType{
				Name: "stop", Expected: "int", Found: "string"},
		},
		{name: "invalid step",
			args:    []tengo.Object{&tengo.Number{}, &tengo.Number{}, &tengo.String{}},
			wantErr: true,
			wantedErr: tengo.ErrInvalidArgumentType{
				Name: "step", Expected: "int", Found: "string"},
		},
		{name: "zero step",
			args:      []tengo.Object{&tengo.Number{}, &tengo.Number{}, &tengo.Number{}}, //must greate than 0
			wantErr:   true,
			wantedErr: tengo.ErrInvalidRangeStep,
		},
		{name: "negative step",
			args:      []tengo.Object{&tengo.Number{}, &tengo.Number{}, intObject(-2)}, //must greate than 0
			wantErr:   true,
			wantedErr: tengo.ErrInvalidRangeStep,
		},
		{name: "same bound",
			args:    []tengo.Object{&tengo.Number{}, &tengo.Number{}},
			wantErr: false,
			result: &tengo.Array{
				Value: nil,
			},
		...
		{name: "positive range",
			args:    []tengo.Object{&tengo.Number{}, &tengo.Number{Value: 5}},
			wantErr: false,
			result: &tengo.Array{
				Value: []tengo.Object{
					intObject(0),
		...
		{name: "positive with step",
			args:    []tengo.Object{&tengo.Number{}, &tengo.Number{Value: 5}, &tengo.Number{Value: 2}},
			wantErr: false,
			result: &tengo.Array{
				Value: []tengo.Object{
					intObject(0),
		...
		{name: "negative with step",
			args:    []tengo.Object{&tengo.Number{}, &tengo.Number{Value: -10}, &tengo.Number{Value: 2}},
			wantErr: false,
			result: &tengo.Array{
				Value: []tengo.Object{
					intObject(0),
		...
		{name: "large range",
			args:    []tengo.Object{intObject(-10), intObject(10), &tengo.Number{Value: 3}},
			wantErr: false,
			result: &tengo.Array{
				Value: []tengo.Object{
					intObject(-10),
