...
var osModule = map[string]tengo.Object{
	"o_rdonly":            &tengo.Number{Value: int64(os.O_RDONLY)},
	"o_wronly":            &tengo.Number{Value: int64(os.O_WRONLY)},
	"o_rdwr":              &tengo.Number{Value: int64(os.O_RDWR)},
	"o_append":            &tengo.Number{Value: int64(os.O_APPEND)},
	"o_create":            &tengo.Number{Value: int64(os.O_CREATE)},
	"o_excl":              &tengo.Number{Value: int64(os.O_EXCL)},
	"o_sync":              &tengo.Number{Value: int64(os.O_SYNC)},
	"o_trunc":             &tengo.Number{Value: int64(os.O_TRUNC)},
	"mode_dir":            &tengo.Number{Value: int64(os.ModeDir)},
	"mode_append":         &tengo.Number{Value: int64(os.ModeAppend)},
	"mode_exclusive":      &tengo.Number{Value: int64(os.ModeExclusive)},
	"mode_temporary":      &tengo.Number{Value: int64(os.ModeTemporary)},
	"mode_symlink":        &tengo.Number{Value: int64(os.ModeSymlink)},
	"mode_device":         &tengo.Number{Value: int64(os.ModeDevice)},
	"mode_named_pipe":     &tengo.Number{Value: int64(os.ModeNamedPipe)},
	"mode_socket":         &tengo.Number{Value: int64(os.ModeSocket)},
	"mode_setuid":         &tengo.Number{Value: int64(os.ModeSetuid)},
	"mode_setgui":         &tengo.Number{Value: int64(os.ModeSetgid)},
	"mode_char_device":    &tengo.Number{Value: int64(os.ModeCharDevice)},
	"mode_sticky":         &tengo.Number{Value: int64(os.ModeSticky)},
	"mode_type":           &tengo.Number{Value: int64(os.ModeType)},
	"mode_perm":           &tengo.Number{Value: int64(os.ModePerm)},
	...
	"seek_set":            &tengo.Number{Value: int64(io.SeekStart)},
	"seek_cur":            &tengo.Number{Value: int64(io.SeekCurrent)},
	"seek_end":            &tengo.Number{Value: int64(io.SeekEnd)},
...
func osStat(args ...tengo.Object) (ret tengo.Object, err error) {
	...
	fstat := &tengo.ImmutableMap{
		Value: map[string]tengo.Object{
			...
			"size":  &tengo.Number{Value: stat.Size()},
			"mode":  &tengo.Number{Value: int64(stat.Mode())},
		},
	}
	if stat.IsDir() {
