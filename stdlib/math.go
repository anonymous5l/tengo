...
var mathModule = map[string]tengo.Object{
	...
	"maxInt":                 &tengo.Number{Value: math.MaxInt},
	"minInt":                 &tengo.Number{Value: math.MinInt},
	"maxInt8":                &tengo.Number{Value: math.MaxInt8},
	"minInt8":                &tengo.Number{Value: math.MinInt8},
	"maxInt16":               &tengo.Number{Value: math.MaxInt16},
	"minInt16":               &tengo.Number{Value: math.MinInt16},
	"maxInt32":               &tengo.Number{Value: math.MaxInt32},
	"minInt32":               &tengo.Number{Value: math.MinInt32},
	"maxInt64":               &tengo.Number{Value: math.MaxInt64},
	"minInt64":               &tengo.Number{Value: math.MinInt64},
