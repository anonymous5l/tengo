...
func TestFuncAIR(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 10})
...
func TestFuncARI(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &tengo.Number{Value: 10}, ret)
	_, err = funcCall(uf, tengo.TrueValue)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
}
...
func TestFuncARIsE(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, array(&tengo.Number{Value: 1},
		&tengo.Number{Value: 2}, &tengo.Number{Value: 3}), ret)
	uf = stdlib.FuncARIsE(func() ([]int, error) {
...
func TestFuncASI64RE(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.String{Value: "foo"}, &tengo.Number{Value: 5})
	require.NoError(t, err)
	require.Equal(t, tengo.TrueValue, ret)
...
func TestFuncAIIRE(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 5}, &tengo.Number{Value: 7})
	require.NoError(t, err)
	require.Equal(t, tengo.TrueValue, ret)
...
func TestFuncAIRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 10.0})
	require.NoError(t, err)
	require.Equal(t, &tengo.Float{Value: 10.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
...
func TestFuncASIRS(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.String{Value: "ab"}, &tengo.Number{Value: 2})
	require.NoError(t, err)
...
func TestFuncAIFRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 10}, &tengo.Float{Value: 20.0})
	require.NoError(t, err)
	require.Equal(t, &tengo.Float{Value: 30.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
...
func TestFuncAFIRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Float{Value: 10.0}, &tengo.Number{Value: 20})
	require.NoError(t, err)
	require.Equal(t, &tengo.Float{Value: 30.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
...
func TestFuncASSIRSs(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.String{Value: "foo"},
		&tengo.String{Value: "bar"}, &tengo.Number{Value: 5})
	require.NoError(t, err)
	require.Equal(t, array(&tengo.String{Value: "foo"},
...
func TestFuncASRIE(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, &tengo.Number{Value: 5}, ret)
...
func TestFuncASSRI(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, &tengo.Number{Value: 6}, ret)
	_, err = funcCall(uf, &tengo.String{Value: "foo"})
	require.Equal(t, tengo.ErrWrongNumArguments, err)
}
...
func TestFuncAIRS(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 55})
	require.NoError(t, err)
...
func TestFuncAIRIs(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 55})
	require.NoError(t, err)
	require.Equal(t, array(&tengo.Number{Value: 55}, &tengo.Number{Value: 55}), ret)
	_, err = funcCall(uf)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
}
...
func TestFuncARI64(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &tengo.Number{Value: 55}, ret)
	_, err = funcCall(uf, &tengo.Number{Value: 55})
	require.Equal(t, tengo.ErrWrongNumArguments, err)
}
...
func TestFuncAI64RI64(t *testing.T) {
	...
	ret, err := funcCall(uf, &tengo.Number{Value: 55})
	require.NoError(t, err)
	require.Equal(t, &tengo.Number{Value: 110}, ret)
	_, err = funcCall(uf)
	require.Equal(t, tengo.ErrWrongNumArguments, err)
}
